export const translations = {
  ar: {
    ...
    contact: {
      ...
      phone: 'الهاتف',
      address: 'العنوان',
      addressValue: 'بجوار النادي الرياضي، كورنيش النيل',
      workingHours: 'ساعات العمل',
      workingHoursValue: 'من 10 صباحاً إلى 10 مساءً',
      followUs: 'تابعنا',
  ...
  en: {
    ...
    contact: {
      ...
      phone: 'Phone',
      address: 'Address',
      addressValue: 'Next to Sports Club, Nile Corniche',
      workingHours: 'Working Hours',
      workingHoursValue: 'From 10 AM to 10 PM',
      followUs: 'Follow Us',
